    ...
    tabs.forEach( tab => {
        tab.onclick = (e) => {
            ...
            if(e.target == lkTab){
                ...
                fvTab.classList.contains("selected")? fvTab.classList.replace("selected", "unselected"): fvTab.classList.add("unselected");
                favesHtml.classList.remove("show");

                lkTab.classList.contains("unselected")?lkTab.classList.replace("unselected", "selected"): lkTab("selected") ;
                ...
                lkTab.classList.contains("selected") ? lkTab.classList.replace("selected", "unselected") : lkTab.classList.add("unselected");
                likesHtml.classList.remove("show");

                fvTab.classList.contains("unselected") ? fvTab.classList.replace("unselected", "selected") : fvTab.classList.add("selected") ;
